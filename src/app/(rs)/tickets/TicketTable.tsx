...
import { CircleCheckIcon, CircleXIcon, ArrowUp, ArrowDown, ArrowUpDown } from "lucide-react"
...
export default function TicketTable({ data }: Props) {
    ...
    usePolling(50000, searchParams.get("searchText")) 
                    ...
                    <div className="flex justify-between items-center gap-1 flex-wrap">
                        <div >
                            <p className="whitespace-nowrap font-bold">
                                {`Page ${table.getState().pagination.pageIndex + 1} of ${Math.max(table.getPageCount())}`}
                                &nbsp;|&nbsp;
